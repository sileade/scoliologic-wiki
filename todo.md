...
- [x] Проанализировать текущую схему MySQL (17 таблиц)
- [x] Установить драйвер PostgreSQL (pg 8.16.3, @types/pg 8.16.0)
- [x] Обновить drizzle.config.ts для PostgreSQL
- [x] Мигрировать schema.ts на синтаксис PostgreSQL
- [x] Обновить db.ts и запросы (node-postgres, returning, onConflictDoUpdate)
- [x] Обновить тесты (143 теста passed)
- [x] Проверить работоспособность (TypeScript 0 errors)
