...
![Главная страница](./screenshot_home.png)

Приветственная страница с навигацией, ключевыми функциями и кнопками для быстрого доступа к wiki, поиску и админ-панели.

### 6.2 Редактор wiki

![Редактор wiki](./screenshot_editor.png)

Основной интерфейс редактора с левой панелью навигации по страницам, центральной областью редактирования с форматированием, и правой панелью с AI-помощником.

### 6.3 Страница поиска

![Страница поиска](./screenshot_search.png)

Интерфейс поиска с выбором режима (текстовый/AI), фильтрами и результатами поиска с выделением найденного текста.

### 6.4 Админ-панель

![Админ-панель](./screenshot_admin.png)

Дашборд администратора с метриками (количество пользователей, страниц, групп), вкладками управления и логом недавней активности.

### 6.5 UI скины в светлой теме

![Главная страница - светлая тема](./skin_home_light.png)

Профессиональный дизайн главной страницы в светлой теме с чистым белым фоном и синими акцентами.

![Редактор - светлая тема](./skin_editor_light.png)

Редактор в светлой теме с удобной навигацией и полным набором инструментов форматирования.

![Поиск - светлая тема](./skin_search_light.png)

Интерфейс поиска в светлой теме с фильтрами и результатами.

### 6.6 UI скины в тёмной теме

![Главная страница - тёмная тема](./skin_home_dark.png)

Профессиональный дизайн главной страницы в тёмной теме с тёмным фоном и синими акцентами для комфортной работы.

![Редактор - тёмная тема](./skin_editor_dark.png)

Редактор в тёмной теме с тем же функционалом, но оптимизированный для работы в условиях низкой освещённости.

![Поиск - тёмная тема](./skin_search_light.png)

Интерфейс поиска в тёмной теме.
...
### 8.2 Авторизация и права доступа
