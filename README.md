...
В админ-панели доступна настройка интеграции с Traefik для управления балансировкой нагрузки:
...
Функции интеграции:
- Проверка подключения к Traefik API
- Получение версии Traefik
- Управление роутерами и сервисами через AI-агент
